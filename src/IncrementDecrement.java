public class IncrementDecrement {
    public static void main(String[] args){
        //los operadores de asignacion (+=, -=, *=, /=, %=), incremento y decremento (++ y --) funcionan igual que en js.
        ...
        //en el postfijo primero se accede a la variable en su valor actual (estaba en 4), se suma a 100, y recien luego incrementa la variable lives. Entonces para esta suma, va a tener como valor 4, pero a su vez, en otro segundo proceso la vide tambien se esta incrementando, así, vida sera = 5.
